<?php 
    ...
    $selectQuery = $mysqli->query("SELECT orderID, userID, sum(quantity) as shoesQty, shoesID, orderedDate, shipmentDate FROM orders GROUP BY orderedDate ORDER BY orderedDate DESC");
