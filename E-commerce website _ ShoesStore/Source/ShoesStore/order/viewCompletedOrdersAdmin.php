<?php 
    ...
    $selectQuery = $mysqli->query("SELECT orderID, userID, sum(quantity) as shoesQty, shoesID, orderedDate, shipmentDate FROM orders GROUP BY orderedDate HAVING shipmentDate IS NOT NULL ORDER BY orderedDate DESC");
